...
class RegressionTest(unittest.TestCase):
    ...
    def test_cat(self):
        from Lesson1Straight import Lesson1Straight
        song = Lesson1Straight()
        song.sing_cat_song()
        verify(song.song,self.reporter)

    def test_beer(self):
        from Lesson2Variable import Lesson2Variable
        song = Lesson2Variable()
        song.sing_beer_song()
        verify(song.song,self.reporter)

    def test_names(self):
        from Lesson21 import Lesson21
        song = Lesson21();
    ...
    def test_primes(self):
        from Lesson3HigherOrderFunctions import Lesson3HigherOrderFunctions
        song = Lesson3HigherOrderFunctions()
        song.sing_song()
        verify(song.song,self.reporter)

    def test_names3(self):
        from Lesson31 import Lesson31
        song = Lesson31();
        names = ["Llewellyn", "Samatha", "Tomas", "Emilia"];
        song.sing_song(1, names);
        song.sing_song(2, names);
